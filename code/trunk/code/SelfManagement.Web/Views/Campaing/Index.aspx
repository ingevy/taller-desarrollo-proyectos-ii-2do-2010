        ...
        <span style="float: left;">
            ...
            <span style="float: right;">
                ...
                <%
                    ...
                    {
                %>
                <%: Html.ActionLink("Terminar Campaña", "End", "Campaing", new { campaingId = this.Model.CampaingId }, new { Class = "btn remove", rel = "nofollow", title = "Terminar Campaña", id = "endCampaing" })%>
                <%
                    }
                %>
